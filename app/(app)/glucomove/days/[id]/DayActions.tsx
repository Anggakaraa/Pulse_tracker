...
export default function DayActions({ dayId }: { dayId: string }) {
  ...
  async function handleDelete() {
    ...
    await supabase.from("glucomove_day_records").delete().eq("id", dayId);
    router.push("/glucomove");
  }

  if (confirming) {
    return (
      <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
        <span style={{ fontFamily: "var(--font-dm-sans)", fontSize: "13px", color: colors.inkMuted }}>Delete this day and all meals?</span>
        <button

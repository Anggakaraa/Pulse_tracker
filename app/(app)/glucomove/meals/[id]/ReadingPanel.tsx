  ...
  return (
    <div style={{ border: `1px solid ${colors.border}`, borderRadius: "6px", overflow: "hidden" }}>
      ...
      {sorted.length === 0 ? (
        ...
        <div>
          <div style={{ display: "grid", gridTemplateColumns: "140px 120px 1fr 32px", padding: "8px 20px", borderBottom: `1px solid ${colors.border}` }}>
            {["Time", "Glucose", "", ""].map((h, i) => (
          ...
          {sorted.map((r, i) => (
            <div key={r.id} style={{ display: "grid", gridTemplateColumns: "140px 120px 1fr 32px", padding: "10px 20px", borderBottom: i < sorted.length - 1 ? `1px solid ${colors.border}` : "none", alignItems: "center" }}>
              ...
              <button
                ...
                style={{ background: "none", border: "none", cursor: "pointer", color: colors.inkMuted, padding: "4px", display: "flex", alignItems: "center", justifyContent: "center" }}
              >
      ...
      {/* Add reading form — always visible */}
      <div style={{ padding: "16px 20px", borderTop: sorted.length > 0 ? `1px solid ${colors.border}` : "none", backgroundColor: colors.background }}>
